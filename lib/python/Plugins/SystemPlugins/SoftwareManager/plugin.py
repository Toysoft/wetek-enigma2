...
class UpdatePluginMenu(Screen):
	...
	def __init__(self, session, args = 0):
		...
		if self.menu == 0:
			...
			if not boxtype.startswith('az') and not boxtype.startswith('dm') and not brandoem.startswith('cube') and not boxtype.startswith('vusolo4k') and not brandoem.startswith('wetek'):
