...
######## Software Manager Menu ##############################
	def Qsoftware(self):
		...
		if not getBoxType().startswith('az') and not getBoxType().startswith('dm') and not getBrandOEM().startswith('cube') and not getBoxType().startswith('vusolo4k') and not getBrandOEM().startswith('wetek'):
